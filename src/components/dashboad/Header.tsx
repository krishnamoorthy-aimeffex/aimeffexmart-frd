      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          >
            ...
            <h1 className="hidden md:block text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">
              Aimeffex Mart
            </h1>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-2 hover:bg-gray-100 rounded-xl cursor-pointer"
            >
              <Search />
            </button>
            ...
            <button
              ...
              className="hidden md:block relative p-2 hover:bg-gray-100 rounded-xl cursor-pointer"
            >
              <ShoppingCart />
              {cartCount > 0 && (
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t bg-white">
          <div className="px-4 py-4 space-y-3">
            ...
            <button
              onClick={() => navigate("/cart")}
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-100 rounded-xl cursor-pointer relative"
            >
              <ShoppingCart />
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
